...
--  See `:help 'list'`
--  and `:help 'listchars'`
--  add `eol = '↲'` to add arrow for end of lines
vim.opt.list = true
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'hcl', 'html', 'json5', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'terraform', 'vim', 'vimdoc' },
